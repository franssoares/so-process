...
- Os arquivos `.cpp` são encontrados [aqui](https://github.com/franssoares/so-process/tree/main/src), 
- O arquivo `.h` pode ser encontrado [aqui](https://github.com/franssoares/so-process/tree/main/include).
...
git clone https://github.com/franssoares/so-process.git
```
...
**Obs:** Este arquivo contém todas as seções necessárias para entender, implementar e executar o programa de detecção de bordas em imagens digitais usando processos POSIX no ambiente Linux.
